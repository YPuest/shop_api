    ...
    public void checkLowStock() {
        ...
        if (!lowStockProducts.isEmpty()) {
            ...
            for (Product product : lowStockProducts) {
                System.out.println(RED + "Product: " + YELLOW + product.getDescription() + RED + " - Only " + product.getStock().getQuantity() + " units left!" + RESET);

                emailService.sendLowStockAlert("admin@example.com", product.getDescription(), product.getStock().getQuantity());
            }
        }
    }
}