...
public class ProductFactory {
    ...
    public static Product createProduct(ProductDescription description, Price price, Stock stock, Category category) {
        return new Product(description, price, stock, category);
    }

    public static Product updateProduct(Product existingProduct, ProductDescription description, Price price, Stock stock) {
